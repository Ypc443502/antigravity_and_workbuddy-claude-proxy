...
const tests = [
    ...
    { name: 'WorkBuddy Chat Normalizer', file: 'workbuddy/test-chat-normalizer.cjs' },
    ...
    { name: 'WorkBuddy Error Handling', file: 'workbuddy/test-errors.cjs' },
    { name: 'WorkBuddy Provider Quota', file: 'workbuddy/test-provider-quota.cjs' },
    { name: 'WorkBuddy Free-Only Protection', file: 'workbuddy/test-free-only.cjs' },
